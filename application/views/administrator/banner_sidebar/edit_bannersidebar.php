...
<div class="row">
        ...
        <div class="card-header py-3">
            ...
            <a href="<?= base_url() ?>administrator/banner_sidebar" class="btn btn-primary btn-icon-split btn-sm float-right">
        ...
        <div class="card-body">
        <?php
              echo form_open_multipart('administrator/edit_bannersidebar');
              ?>
              <div class="col-12 col-lg-11 col-xl-10 col-centered">
               <input type="hidden" name="id_iklan" value="<?= $rows['id_iklan'] ?>">
        <div class="form-group row">
                        <label for="nama-link" class="col-12 col-lg-3 mt-2">Judul</label>
                        <div class="col-12 col-lg-9">
                        <input autocomplete="off" type="text" class="form-control" id="judul" name="judul" value="<?= $rows['judul'] ?>">
                        </div>
                    </div>
        <div class="form-group row">
                        <label for="url" class="col-12 col-lg-3 mt-2">Link</label>
                        <div class="col-12 col-lg-9">
                            <div class="input-group mb-2">
                            <div class="input-group-prepend">
          <div class="input-group-text">http://</div>
        </div>
                        <input autocomplete="off" type="text" class="form-control" id="url" name="url" value="<?= $rows['url'] ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-9">
                        <img class="mb-4" src="<?= base_url() .'upload/img_sidebar/'.$rows['gambar'] ?>" style="border-radius:2px; max-width: 100%;">
        ...
        <a type="button" class="mb-3 float-right btn btn-secondary btn-icon-split btn-sm" href="<?= base_url() ?>administrator/banner_sidebar">
                    <span class="icon text-white-50">
