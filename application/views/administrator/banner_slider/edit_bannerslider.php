...
<div class="row">
        ...
        <div class="card-header py-3">
            ...
            <a href="<?= base_url() ?>administrator/banner_slider" class="btn btn-primary btn-icon-split btn-sm float-right">
        ...
        <div class="card-body">
        <?php
              echo form_open_multipart('administrator/edit_bannerslider');
              ?>
              <div class="col-12 col-lg-11 col-xl-10 col-centered">
               ...
               <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-9">
                        <img class="mb-4" src="<?= base_url() .'upload/img_banner/'.$proses['gambar'] ?>" alt="<?= $proses['keterangan_gambar'] ?>"  width="100%" style="border-radius:8px;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-9">
                        <input autocomplete="off" type="number"  class="form-control" id="urutan" name="urutan" value="<?= $proses['urutan'] ?>">
                        </div>
                    </div>
                    </div>
                    </div>
        ...
        <a type="button" class="mb-3 float-right btn btn-secondary btn-icon-split btn-sm" href="<?= base_url() ?>administrator/banner_slider">
                    <span class="icon text-white-50">
