        ...
        <div class="col-sm-4">
            ...
            <div class="table-responsive table-conf">
                <table class="table table-bordered view-table" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        foreach ($berita as $row){
                            ...
                            if ($row['terbit'] == 'Y'){
                                $terbit = "<a class='tidak-terbit-data' title='Terbit' href='".base_url(). "administrator/terbit_berita/$row[id_berita]/$row[terbit]'><i class='fas fa-thumbs-up fa-xs'
                                style='color: #1cc88a'></i></a>&nbsp;";
                            }else{
                                $terbit = "<a class='terbit-data' title='Tidak Terbit' href='" .base_url(). "administrator/terbit_berita/$row[id_berita]/$row[terbit]'><i class=' fas fa-thumbs-down fa-xs'
                        ...
                        echo "
                            ...
                            <td>
                                <a class='edit-data' href='".base_url()."administrator/edit_berita/$row[id_berita]' title='Ubah' id='ubah'
                ><i class='fas fa-edit fa-xs'
                                ...
                                <a id='deleteData' href='".base_url()."administrator/hapus_berita/$row[id_berita]' class='hapus-data' title='Hapus'><i
...
$('.hapus-data').on("click", function(e) {
  ...
  Swal.fire({
      title: "Hapus berita",
      text: "Yakin ingin menghapus berita?",
      icon: "warning",
...
$('.terbit-data').on("click", function(e) {
  ...
  Swal.fire({
      title: "Terbitkan",
      text: "Yakin ingin menerbitkan berita?",
      icon: "warning",
      showCancelButton: true,
      ...
      if (result.isConfirmed) {
        Swal.fire({
            title: "Terbit",
            text: "Berita berhasil diterbitkan!", icon: "success",
            timer: 2000,
            showConfirmButton: false
        }).then(function(){
            window.location.replace(url);
...
$('.tidak-terbit-data').on("click", function(e) {
  ...
  Swal.fire({
      title: "Tidak terbit",
      text: "Yakin ingin tidak terbitkan berita?",
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: '#e74a3b',
