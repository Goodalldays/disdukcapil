...
<div class="row">
        ...
        <div class="card-header py-3">
            <h6 class="mt-2 font-weight-bold text-primary float-left">Edit Daftar Putar</h6>
            <a href="<?= base_url() ?>administrator/daftar_putar" class="btn btn-primary btn-icon-split btn-sm float-right">
        ...
        <div class="card-body">
        <?php
              echo form_open_multipart('administrator/edit_daftarputar');
              ?>
              <div class="col-12 col-lg-10 col-xl-8 col-centered">
               <input type="hidden" name="id-playlist" value="<?= $proses['id_playlist'] ?>">

               <div class="form-group row">
                        <label for="judul" class="col-12 col-lg-2 mt-2">Daftar Putar</label>
                        <div class="col-12 col-lg-10">
                        <input autocomplete="off" type="text" class="form-control" id="daftar-putar" name="daftar-putar" value="<?= $proses['jdl_playlist'] ?>">
                        </div>
                    </div>
                    <hr>
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-10">
                        <img class="mb-4" src="<?= base_url() .'upload/img_playlist/'.$proses['gbr_playlist'] ?>" alt="<?= $proses['keterangan'] ?>"  width="50%" style="border-radius:2px;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-lg-10">
                        <textarea name="deskripsi" class='form-control' style='height:100px'><?= $proses['deskripsi_playlist'] ?></textarea>
                        </div>
                    </div>
                    </div>
                    </div>
        ...
        <a type="button" class="mb-3 float-right btn btn-secondary btn-icon-split btn-sm" href="<?= base_url() ?>administrator/daftar_putar">
                    <span class="icon text-white-50">
