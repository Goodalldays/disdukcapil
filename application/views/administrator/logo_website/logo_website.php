...
<div class="card shadow mb-4" id="data-logo-website">
  ...
  <div class="card-body">
    <?php
      echo form_open_multipart('administrator/logo_website');
      foreach ($record->result_array() as $row){
    ?>
    <div class="col-12 col-lg-11 col-xl-10 col-centered">
      <input type='hidden' name='id' value='<?= $row['id_logo']?>'>
        <div class="form-group row">
          <label for="logo" class="col-12 col-lg-3 mt-2 ">Logo Terpasang</label><br>
          <div class="col-12 col-lg-9">
            <img src='<?= base_url()?>upload/img_logo/<?= $row['gambar']?>'>
          </div>
          </div>
            <div class="form-group row">
              <label for="gambar" class="col-12 col-lg-3 mt-2 ">Logo</label><br>
              <div class="col-12 col-lg-9">
