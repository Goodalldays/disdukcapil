...
<div class="row">
        ...
        <div class="card-header py-3">
            ...
            <!-- <a href="<?= base_url() ?>administrator/tanda_berita" class="btn btn-primary btn-icon-split btn-sm float-right">
              ...
              <div class="col-12 col-lg-10 col-xl-8 col-centered">
               <input type="hidden" name="id_tag" value="<?= $proses['id_tag'] ?>">
                    <div class="form-group row">
                        <label for="judul" class="col-12 col-lg-2 font-weight-bold mt-2">Tanda</label>
