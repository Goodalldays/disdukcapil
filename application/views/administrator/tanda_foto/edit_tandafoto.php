<div class="container-fluid" id="edit-tandafoto">
<div class="row">
        ...
        <div class="card-header py-3">
            ...
            <a href="<?= base_url() ?>administrator/tanda_foto" class="btn btn-primary btn-icon-split btn-sm float-right">
        ...
        <div class="card-body">
        <?php
              echo form_open_multipart('administrator/edit_tandafoto');
              ?>
