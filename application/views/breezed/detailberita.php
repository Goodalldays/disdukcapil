      ...
      <div class="row">
        <div class="col-12 col-lg-8" style="padding-right: 25px;">
          ...
          <div data-scroll-reveal="enter bottom move 30px over 0.4s after 0.2s">
            ...
            <?php } else { ?>
              <img class="image-berita" src="<?= base_url() ?>upload/img_berita/<?=  $rows['gambar'] ?>" alt="<?= $rows['judul'] ?>">
            <?php } ?>
</div>
<div data-scroll-reveal="enter left move 50px over 0.4s after 0.2s">
            ...
            <div class="post-meta" style="font-size: 14px;">
              <a class="link-disable" href="#"><i class="fa fa-calendar"></i> <?php echo tgl_indo($rows['tanggal']); ?></a>
          ...
          <tbody>
            <tr>
              <td><div class="mr-4">Kategori</div></td>
              <td><div class="mr-2">:</div></td>
              <td><span class='badge badge-success mr-1'><?= $rows['nama_kategori']; ?></span></td>
            </tr>
            <tr>
            <td>Tanda</td>
            <td>:</td>
          ...
          $tags = $this->model_app->view_where('tag_berita', array('tag_seo' => $tanda))->row_array();
echo "<span class='badge badge-success mr-1'>$tags[nama_tag]</span></h1>";
          ...
          <div class="post-share-area" data-scroll-reveal="enter bottom move 10px over 0.8s after 0.5s">
            ...
            <a href="https://www.facebook.com/sharer.php?u=<?php echo base_url() ?>berita/detail/<?php echo $rows['judul_seo']; ?>" target="_blank" class="facebook" data-toggle="tooltip" data-placement="top" title="Bagikan di facebook"><i class="fa fa-facebook"></i> Share</a>
            <a href="https://twitter.com/share?url=<?php echo base_url() ?>berita/detail/<?php echo $rows['judul_seo']; ?>" target="_blank" class="tweet" data-toggle="tooltip" data-placement="top" title="Bagikan di twitter"><i class="fa fa-twitter"></i> Tweet</a>
            ...
            <a href="https://wa.me//send?text=<?php echo base_url() ?>berita/detail/<?php echo $rows['judul_seo']; ?>" target="_blank" class="whatsapp" data-toggle="tooltip" data-placement="top" title="Bagikan di whatsapp"><i class="fa fa-whatsapp"></i> Share</a>
            <a href="https://t.me/share/url?url=<?php echo base_url() ?>berita/detail/<?php echo $rows['judul_seo']; ?>" target="_blank" class="telegram" data-toggle="tooltip" data-placement="top" title="Bagikan di telegram"><i class="fa fa-telegram"></i> Share</a>
          </div>
          ...
          <div class="single-widget-area" data-scroll-reveal="enter left and move 30px over 0.9s" style="margin-bottom: 0; margin-top:50px">
                <div class="section-heading mb-3">
                  <h5><i class="fa fa-newspaper-o"></i> BERITA TERKAIT :</h5>
                </div>
                <?php
          $no = 1;
          $sb1 = $this->model_utama->view_where_ordering_limit('berita', array('terbit'=>'Y'),'id_berita', 'DESC', 0, 5);
          ...
          ?>
                  <div class="single-news-area d-flex align-items-center">
                    ...
                    <div class="blog-content-sidebar">
                      <a href="<?php echo base_url('berita/detail/' . $r['judul_seo']) ?>" class="post-title"><?php echo character_limiter($r['judul'], 70); ?></a>
