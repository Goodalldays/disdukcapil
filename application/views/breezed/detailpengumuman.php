            ...
            <div class="row">
                <div class="col-12 col-lg-8" style="padding-right: 25px;">
                    ...
                    <div data-scroll-reveal="enter bottom move 30px over 0.4s after 0.2s">
                        ...
                        <?php } else { ?>
                            <img class="image-pengumuman" src="<?php echo base_url() . "upload/foto_pengumuman/" . $rows['gambar'] ?>" alt="<?php echo $rows['judul'] ?>">
                        <?php } ?>
</div>
...
<div class="line-bottom" data-scroll-reveal="enter bottom move 10px over 0.8s after 0.5s" style="margin: 0"></div>
                ...
                <div class="section-heading mb-3">
                  <h5><i class="fa fa-newspaper-o"></i> PENGUMUMAN TERKAIT :</h5>
                </div>
                <?php
                    $no = 1;
                    $sb1 = $this->model_utama->view_where_ordering_limit('pengumuman', array('aktif'=> 'Y'), 'id_pengumuman', 'DESC', 0, 5);
                    ...
                    ?>
                      ...
                      <div class="single-news-area d-flex align-items-center">
                          <div class="blog-thumbnail-sidebar">
                              <?php if ($r['gambar'] != '') { ?>
                                  <img src="<?php echo base_url() ?>upload/foto_pengumuman/<?php echo $r["gambar"] ?>" alt="">
                              <?php } else { ?>
                          ...
                          <div class="blog-content-sidebar">
                              <a href="<?php echo base_url('pengumuman/detail/' . $r['judul_seo']) ?>" class="post-title"><?php echo character_limiter($r['judul'], 70); ?></a>
                              <span class="post-date color-icon"><i class="fa fa-calendar"></i> <?php echo tgl_indo($r['tgl_posting']); ?> </span>
                          </div>
                      </div>
                  <?php $no++;
                    } ?>
