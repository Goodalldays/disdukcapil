          ...
          <div class="blog-details-area">
            <div data-scroll-reveal="enter bottom move 30px over 0.4s after 0.2s" style="margin-bottom:20px;">
              ...
              <div class="post-meta" style="font-size: 14px;">
                ...
                <a class="link-disable" href="#"><i class="fa fa-eye"></i> <?= number_format($rows['dilihat'] + 1); ?>x ditonton</a>
...
<div data-scroll-reveal="enter left move 50px over 0.4s after 0.2s">
  <?php  if($rows['youtube'] != null){
  ?>
<div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="<?= convertYoutube($rows['youtube']); ?>" title="<?= $rows['judul_video']; ?>" height="100%" width="100%" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <?php } ?>
            <div class="isi-berita-long" style="margin-top: 24px;">
            <p>
              <?= $rows['deskripsi']; ?>
            </p>
            </div>
          ...
          <tbody>
            <tr>
              <td><div class="mr-4">Daftar Putar</div></td>
              <td><div class="mr-2">:</div></td>
              <td><span class='badge badge-success mr-1'><?= $rows['jdl_playlist']; ?></span></td>
            </tr>
            <tr>
            <td>Tanda</td>
            <td>:</td>
          ...
          $tags = $this->model_app->view_where('tag_video', array('tag_seo' => $tanda))->row_array();
echo "<span class='badge badge-success mr-1'>$tags[nama_tag]</span></h1>";
          ...
          <div class="single-widget-area" data-scroll-reveal="enter left and move 30px over 0.9s" style="margin-bottom: 0; margin-top:50px">
                <div class="section-heading mb-3">
                  <h5><i class="fa fa-newspaper-o"></i> VIDEO TERKAIT :</h5>
                </div>
                <?php
          $no = 1;
          $sb1 = $this->model_utama->view_where_ordering_limit('video', array('terbit'=>'Y'), 'id_video', 'DESC', 0, 5);
          foreach ($sb1->result_array() as $r) {

          ?>
                  <div class="single-news-area d-flex align-items-center">
                    <div class="blog-thumbnail-sidebar">
                    <?php if ($r['gambar_video'] != '') { ?>
                    <a href="<?php echo base_url('video/detail/' . $r['seo_video']) ?>">
                        <img src="<?= base_url(); ?>upload/img_video/<?= $r['gambar_video'] ?>" alt="">
                      <?php } else { ?>
                        <img src="<?= base_url(); ?>upload/img_video/no-image.jpg" alt="<?= $r['keterangan'] ?>"></a>
                      <?php } ?>

                    </div>
                    <div class="blog-content-sidebar">
                      <a href="<?php echo base_url('video/detail/' . $r['seo_video']) ?>" class="post-title"><?php echo character_limiter($r['judul_video'], 70); ?></a>
