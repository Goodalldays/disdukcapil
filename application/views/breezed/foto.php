    ...
    <div class="container" style="margin-top: 130px;">
      ...
      <div class="row">
        <div class="col-12 col-lg-8" style="padding-right: 25px;">
          ...
          <?php
              if (empty($galeri->result_array()))
              {
                echo "<div><img data-scroll-reveal='enter left move 30px over 0.6s after 0.8s' class='kosong' src='".base_url()."assets/template/breezed/img/undraw_Posting_photo_re_plk8.svg'></div><h5 class='text-center' data-scroll-reveal='enter left move 30px over 0.6s after 0.8s'>Tidak ada foto!</h5>";
              }
              ?>
          ...
          foreach ($galeri->result_array() as $x1) {
          ?>
            ...
            <div class="single-blog-item style-2 d-flex flex-wrap mb-20" data-scroll-reveal="enter bottom move 30px over 0.4s after 0.4s">
              ...
              <?php
                          ...
                          ?>
                <a href="<?php echo base_url('foto/detail/' . $x1['seo_galeri']) ?>"><?php if ($gambar == '') {
                                                                                        echo "<img  src='" . base_url() . "upload/img_album/no-image.jpg' alt='no-image.jpg' style='width:100%; height:160px; border-radius: 2px;'/>";
                                                                                      } else { ?>
                    <img class="hover2" src=" <?php echo base_url() . "upload/img_galeri/" . $gambar[0]; ?>" alt="" style="width:100%; height:160px; border-radius: 2px;"><?php } ?></a>
              </div>
              <!-- Blog Content -->
              <div class="blog-content">
                ...
                <div class="post-meta" style="font-size: 13px;">
                  ...
                  <a class="link-disable" href="#"><i class="fa fa-eye"></i> <?php echo number_format($x1['dilihat'] + 1); ?>x dilihat</a>
                </div>
                <a href="<?php echo base_url('foto/detail/' . $x1['seo_galeri']) ?>" class="post-title" style="font-size: 18px;">
                  <?php echo $x1['judul_galeri'] ?></a>
                <p>
                  <?php
