        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-heading" style="margin-bottom: 30px;">
                        <h6 data-scroll-reveal="enter left move 10px over 0.4s after 0.2s">Pengumuman</h6>
                        <h2 data-scroll-reveal="enter left move 20px over 0.6s after 0.4s">Pengumuman</h2>
                    </div>
