...
<div style='margin-top: -30px';></div>
                    ...
                    foreach ($pengumuman->result_array() as $x1) {
                    ?>
                        <div class="single-blog-item style-2 d-flex flex-wrap mb-20">

                            <div class="blog-thumbnail mt-30">
                                <a href="<?php echo base_url('pengumuman/detail/' . $x1['judul_seo']) ?>"><?php if ($x1['gambar'] == '') {

                                                                                                                echo "<img  src='" . base_url() . "asset/img_album/no-image.jpg' alt='no-image.jpg' style='width:100%; height:160px; border-radius: 2px;'/>";
                                                                                                            } else { ?>
                                        <img class="" src=" <?php echo base_url() . "asset/foto_pengumuman/" . $x1['gambar']; ?>" alt="" style="width:100%; height:160px; border-radius: 2px;"><?php } ?></a>
                            </div>

                            <div class="blog-content">
                                <a href="<?php echo base_url('pengumuman/detail/' . $x1['judul_seo']) ?>" class="post-title" style="font-size: 18px;">
                                    <?php echo $x1['judul'] ?></a>
                                <p>
                                    <?php
                                    $xberita = strip_tags(html_entity_decode($x1['isi']));
